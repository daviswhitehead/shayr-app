// write samples
exports.writeSample = (db, obj) => {
  return obj.data.map((data, id) => {
    return db.doc(obj.path + id).set(data)
    .then((value) => {
    ...
    data: [
      {
        ...
        updatedAt: ts,
        url: 'https://www.nytimes.com/2018/04/03/business/media/spotifys-wall-street-debut-is-a-success.html',
      }
    ]
  }
}
  ...
  return [
    ...
    },
    {
      ...
      payload: {
        createdAt: null,
        updatedAt: null,
        url: 'https://newyorker.com/humor/daily-shouts/a-deep-dive-to-remember-a-love-story-between-business-managers-written-by-a-business-manager',
      }
    },
    // {
...
exports.posts = (ts) => {
  return {
    ...
    data: [
      ...
      {
        createdAt: ts,
        description: 'After its first day on the New York Stock Exchange, the music streaming service was valued at $26.5 billion, putting it in the company of firms like General Mills.',
        image: 'https://static01.nyt.com/images/2018/04/04/business/04SPOTIFY1/04SPOTIFY1-facebookJumbo.jpg',
        medium: 'article',
        publisher: {
          logo: '',
          name: '@nytimes'
        ...
        updatedAt: ts,
        url: 'https://nytimes.com/2018/04/03/business/media/spotifys-wall-street-debut-is-a-success.html',
      },
    ]
  }
}
